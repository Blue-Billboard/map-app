...
- [x] **Phase 1: Map Tiles** - Replace OpenStreetMap tiles with Stadia Maps Alidade Smooth, fix dark mode
- [x] **Phase 2: Premium Pins** - Redesign venue pins to unified premium design, clean up level-based code
...
Plans:
- [x] 01-01-PLAN.md — Replace OSM tiles with dual Stadia Alidade Smooth layers, remove CSS invert hack
...
Plans:
- [x] 02-01-PLAN.md — Remove levelColour from divIcon, add premium CSS fill, hover scale, dark mode override
- [x] 02-02-PLAN.md — Add variant toggle, user approval checkpoint, strip variant code post-approval
...
|-------|----------------|--------|-----------|
| 1. Map Tiles | 1/1 | Complete | 2026-03-01 |
| 2. Premium Pins | 2/2 | Complete    | 2026-03-01 |
